  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/60 bg-background/85 backdrop-blur supports-[backdrop-filter]:bg-background/70">
      <div className="hidden md:flex items-center justify-between border-b border-border/40 px-6 py-1.5 text-xs text-muted-foreground">
        <p>Open 24/7 · NABH & JCI accredited</p>
        <div className="flex items-center gap-4">
          <a href="tel:911" className="inline-flex items-center gap-1.5 font-medium text-destructive">
            <Phone className="h-3.5 w-3.5" /> Emergency: 911-XYZ
          </a>
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-6">
        <Link to="/" className="flex items-center gap-2">
          ...
          <div className="leading-tight">
            <div className="font-display text-lg font-bold tracking-tight">XYZ Hospital</div>
        ...
        <div className="lg:hidden border-t border-border bg-background">
          <div className="flex flex-col gap-1 p-3">
            ...
            <div className="mt-2 flex gap-2 border-t border-border pt-3">
              <Button asChild variant="outline" size="sm" className="flex-1"><Link to="/doctors" onClick={() => setOpen(false)}>Find a doctor</Link></Button>
